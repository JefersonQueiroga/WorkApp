...
class PerfilForm(forms.ModelForm):
    ...
    class Meta:
        model = UsuarioAdaptado
        fields = ['first_name', 'last_name', 'email', 'foto_perfil', 'nome_cidade', 'nome_mae', 'endereco', 'nome_bairro']
        widgets = {
...
class UsuarioEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'nome_cidade', 'nome_mae', 'endereco', 'nome_bairro', 
